...
# Define the ticker symbol and set the time period for analysis
ticker_symbol = "XOM"
...
# Determine the trend of each day
...
# Group by each period and summarize
period_summary = data.groupby(['Period Start', 'Trend']).agg(
